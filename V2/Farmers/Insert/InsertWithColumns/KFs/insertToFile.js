...
const StartFunc = ({LocalCoumnFarmerName,LocalCoumnFarmerMobile,LocalCoumnFarmerCity,LocalCoumnFarmerField}) => {
  const LocalFileName = ParamsJson.TableName;
  const LocalDataPath = ParamsJson.DataPath;

  let LocalinDataToInsert = {FarmerName : LocalCoumnFarmerName,FarmerMobile : LocalCoumnFarmerMobile,FarmerCity : LocalCoumnFarmerCity,FarmerField : LocalCoumnFarmerField};
